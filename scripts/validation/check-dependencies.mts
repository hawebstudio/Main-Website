import { printResult, readJson, readText, walkFiles, type AuditMessage } from '../shared/toolkit.mts'
...
for (const file of [...walkFiles('app', ['.mts', '.tsx']), ...walkFiles('components', ['.mts', '.tsx']), ...walkFiles('lib', ['.mts', '.tsx'])]) {
